...
def process():
    ...
    while running:
        ...
        word_label.config(text="Recognized Word: " + word)
...
window = tk.Tk()
window.title("Hand Tracking and Classification")
...
word_label = tk.Label(window, text="Recognized Word: ", font=("Arial", 16))
word_label.pack()
...
# labels =["1","2","3","4","5","6","7","8","9","A","B","C","D","E","F","G"]


labels = ["1","2","3","4","5","6","7","8","9","A", "B", "C", "D", "E",
